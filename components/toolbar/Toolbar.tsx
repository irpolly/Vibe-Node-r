...
import { TrashIcon, AlignIcon, ResetIcon } from '../../constants.tsx';
...
const Toolbar: React.FC<ToolbarProps> = ({ onFinalize, onToggleDeleteMode, isDeletingMode, onShowSubmission, onAutoAlign, onResetLayout, isLoading }) => {
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-full shadow-lg p-2 flex items-center gap-2">
      ...
      <Button onClick={onAutoAlign} variant="ghost">
