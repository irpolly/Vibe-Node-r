...
import { TrashIcon, AlignIcon } from '../../constants.tsx';
...
const Toolbar: React.FC<ToolbarProps> = ({ onFinalize, onToggleDeleteMode, isDeletingMode, onShowSubmission, onAutoAlign, isLoading }) => {
  return (
